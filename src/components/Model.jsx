...
export default function Model(props) {
  ...
  //   // Mouse is in [-1, 1] for both axes
  //   const targetX = mouse.x * 0.5
  //   const targetY = mouse.y * 0.5

  //   // Optional: smooth the rotation
  //   catHeadRef.current.rotation.y += (targetX - catHeadRef.current.rotation.y) * 0.1
  //   catHeadRef.current.rotation.x += (targetY - catHeadRef.current.rotation.x) * 0.1
  // })
  return (
