  export const education = [
    {
      ...
      degree: "M.S Informatics, specializing in Cybersecurity",
  ...
  export const tech = [
    ...
    {tech: 'TypeScript', img: ''},
    {tech: 'JavaScript', img: ''},
    {tech: 'RESTful APIs', img: ''},
    {tech: 'TensorFlow.js', img: ''},
    {tech: 'Three.js', img: ''},
    {tech: 'Figma', img: ''},
    {tech: 'Blender', img: ''},
    {tech: 'Adobe Illustrator', img: ''}
  ];
